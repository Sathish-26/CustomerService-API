...
public class SwaggerConfiguration {
	...
	private ApiInfo metaData() {
		...
		ApiInfo apiInfo = new ApiInfo("Spring Boot REST API", "Spring Boot REST API for Customer Service", "1.0",
				"Terms of service", new Contact("Sathish", "", ""), "Apache License Version 2.0",
